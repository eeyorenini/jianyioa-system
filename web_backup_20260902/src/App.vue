    ...
    <div class="mobile-navbar" v-if="isMobile">
      ...
      <div class="mobile-navbar-right">
        <el-dropdown trigger="click">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click="router.push('/personal-center')">{{ currentUserName }}</el-dropdown-item>
    ...
    <el-aside v-if="!isMobile" width="220px">
      ...
      >
        ...
        <el-sub-menu index="customer-group">
          ...
          <el-menu-item index="/budgets">预算报价</el-menu-item>
        </el-sub-menu>
...
import {
  ...
  Wallet, Setting, Ticket, Fold, Expand
...
const getCurrentUser = () => {
  try {
    ...
    if (userStr) {
      ...
      currentUserName.value = user.name || user.username || '管理员'
    }
  } catch (e) {
...
const pageTitle = computed(() => {
  const titles = {
    ...
    '/customers': '客户管理', '/channels': '渠道管理',
    '/contracts': '合同管理', '/contract-templates': '合同模板',
